                ...
                <div class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" v-model="form.name" placeholder="请输入权限组名称" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">权限组描述</label>
                        <div class="layui-input-inline">
                            <input type="text" v-model="form.description" placeholder="请输入权限组描述" class="layui-input">
                        </div>
                    </div>
                </div>
